    ...
    <style>
        ...
        * {
        ...
        .badge-dongkrak {
            ...
            display: none; /* Hide badge dongkrak */
        }
        ...
        <table class="main-table">
            ...
            <tbody>
                ...
                @php
                    $nilai = $data['nilai'];
                    $mapel = $data['mapel'];
                    $nilaiAkhir = $data['nilai_akhir']; // Ini sudah nilai dongkrak dari controller
                    
                    // Predikat berdasarkan nilai dongkrak
                    if ($nilaiAkhir >= 90) {
                        $predikat = 'A';
                    ...
                    // Generate deskripsi detail berdasarkan komponen (sama seperti print asli)
                    $komponenTertinggi = '';
                    $komponenTerendah = '';
                    $nilaiTertinggi = 0;
                    $nilaiTerendah = 100;
                ...
                <tr>
                    ...
                    <td class="col-nilai">
                        <strong>{{ number_format($nilaiAkhir, 0) }}</strong>
                    </td>
