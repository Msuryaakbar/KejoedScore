...
<div class="max-w-2xl mx-auto">
    <h2 class="text-3xl font-bold mb-6">Edit Siswa</h2>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('siswa.update', $siswa) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama" class="w-full border rounded px-3 py-2" value="{{ old('nama', $siswa->nama) }}" required>
            </div>

            <div class="mb-4">
                <label class="block text-gray-700 mb-2">NIS</label>
                <input type="text" name="nis" class="w-full border rounded px-3 py-2" value="{{ old('nis', $siswa->nis) }}" required>
            </div>
