    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 md:mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                <div class="md:ml-2">
                    <h1 class="text-xl md:text-2xl font-bold text-gray-900">Rekap Nilai Siswa</h1>
                    <p class="text-gray-600 mt-1 text-sm md:text-base">Lihat rekap nilai dan predikat seluruh siswa per kelas</p>
                </div>
                <div class="flex items-center gap-2 text-sm text-gray-500 bg-blue-50 px-3 py-2 rounded-lg border border-blue-200">
                    <i class="fas fa-chart-bar text-blue-500"></i>
                    <span>Pilih kelas untuk melihat rekap nilai</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-2xl p-8 text-center max-w-2xl mx-auto">
            ...
            <p class="text-amber-700 mb-2 text-sm md:text-base">Anda perlu menambahkan kelas terlebih dahulu sebelum dapat melihat rekap nilai.</p>
            <p class="text-amber-600 text-xs md:text-sm mb-6">Setelah kelas dibuat dan data nilai diinput, rekap nilai akan tersedia di sini.</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <select class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500" id="filter-select">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8" id="kelas-grid">
            @foreach($kelas as $k)
                ...
                <div class="group relative kelas-card" 
                    ...
                    <a href="{{ route('nilai.rekap.show', $k->id) }}" 
                       class="block bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 transform hover:-translate-y-1 border border-gray-200 hover:border-purple-300 overflow-hidden h-full focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                        <!-- Header dengan Gradient -->
                        <div class="bg-gradient-to-r from-purple-500 to-indigo-600 p-4 md:p-5 text-white relative overflow-hidden">
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="flex items-center gap-2 text-purple-100 text-xs md:text-sm">
                        ...
                        <div class="p-4 md:p-5">
                            ...
                            <div class="grid grid-cols-2 gap-2 md:gap-3 mb-3 md:mb-4">
                                <div class="text-center bg-purple-50 rounded-lg p-2">
                                    <div class="text-base md:text-lg font-bold text-purple-600">{{ $k->siswa_count ?? 0 }}</div>
                                    <div class="text-xs text-purple-500 font-medium">Siswa</div>
                                </div>
                            ...
                            <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                                <span class="text-sm text-gray-500 group-hover:text-purple-600 transition-colors font-medium">
                                    Lihat Rekap
                                </span>
                                <div class="transform group-hover:translate-x-1 transition-transform">
                                    <i class="fas fa-chevron-right text-gray-400 group-hover:text-purple-500 text-xs"></i>
                                </div>
                            </div>
                        </div>
                        
                        <!-- Hover Effect -->
                        <div class="absolute inset-0 border-2 border-transparent group-hover:border-purple-400 rounded-xl transition-all duration-300 pointer-events-none"></div>
                    </a>
                </div>
                @endif
            @endforeach
        ...
        <div class="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 border border-purple-200">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    <h3 class="font-bold text-purple-900 mb-3 text-lg">Informasi Rekap Nilai</h3>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        <div class="bg-white rounded-xl p-4 border border-purple-100">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <span class="font-semibold text-purple-800">Rekap Lengkap</span>
                            </div>
                            <p class="text-gray-600 text-xs leading-relaxed">Lihat nilai semua mata pelajaran dalam satu tampilan</p>
                        </div>
                        <div class="bg-white rounded-xl p-4 border border-green-100">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <span class="font-semibold text-green-800">Predikat Nilai</span>
                            </div>
                            <p class="text-gray-600 text-xs leading-relaxed">Sistem otomatis menghitung predikat berdasarkan nilai akhir</p>
                        </div>
                        <div class="bg-white rounded-xl p-4 border border-blue-100">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <span class="font-semibold text-blue-800">Analisis Data</span>
                            </div>
                            <p class="text-gray-600 text-xs leading-relaxed">Dapatkan insight performa belajar siswa secara keseluruhan</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mt-6">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <a href="{{ route('nilai.pilih-mapel') ?? route('mata-pelajaran.index') }}" 
                ...
                <a href="{{ route('rapor.index') }}" 
                   class="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
